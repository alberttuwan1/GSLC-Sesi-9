...
public class Admin extends Person {
	...
	public void addStudent() {
		...
		System.out.println("Your ID is " + temp.getStdId());
		Util.enter();
	}
	...
	public void addTeacher() {
		...
		System.out.println("Your ID is " + temp.getTchId());
		Util.enter();
	}
	...
	// enable student to change password
	...
	// enable a teacher to change a password
